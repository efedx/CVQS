...
public class TerminalLogAspect {
    ...
    @Pointcut("execution(* com.employee.services.RegisterTerminalsService.*(..))") // return type, class, method with any parameters
    public void RegisterTerminalsPointCut() {}

    @Pointcut("execution(* com.employee.services.ListTerminalsService.*(..))") // return type, class, method with any parameters
